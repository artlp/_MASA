...
/* ANAGRAMS */
const btnNewAnagram = document.querySelector('.new-anagram');
const anagram = document.querySelector('#anagram');

function getRandomWord() {
    anagram.value = anagrams[Math.floor(Math.random() * anagrams.length)];
}

btnNewAnagram.addEventListener('click', getRandomWord);